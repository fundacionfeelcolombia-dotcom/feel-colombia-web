...
export default function ModalCounseling({
  ...
  const motivosOptions = [
    ...
    "Situaciones de crianza / hijos",
    "Dificultad para dormir",
    "Orientación espiritual + emocional",
  ];
  ...
  return (
    <DialogContent className="w-[95%] md:w-[800px] max-w-[900px] max-h-none [&>button]:hidden p-0">
      <div className="flex flex-col overflow-y-auto  h-[80vh] rounded-2xl">
        ...
        <div className="flex items-center justify-between p-6 border-b border-border sticky top-0 bg-background">
          <div>
            ...
            <p className="text-sm text-muted-foreground mt-1">
              Completa este formulario para conocerte
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div>
                <label className="flex items-start gap-3 cursor-pointer">
                  ...
                  />
                  <textarea
                    placeholder="Otro (cuéntanos brevemente)"
          ...
          <div>
            <label className="block text-sm font-semibold text-foreground mb-3">
              ¿Qué modalidad prefieres? <span className="text-red-500">*</span>
            </label>
            <div className="space-y-2">
